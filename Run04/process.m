...
u0 = read_fortran_box('RESTART_Run04_u.000000', 384, 384, 384, 'double');
v0 = read_fortran_box('RESTART_Run04_v.000000', 384, 384, 384, 'double');
w0 = read_fortran_box('RESTART_Run04_w.000000', 384, 384, 384, 'double');
...
Emean=zeros(67,500);
Omegamean=zeros(67,500);
tvec=zeros(67,1);
Evec=zeros(67,1);
epsilonvec=zeros(67,1);
...
% Integral length
l=trapz(kline(2:end),(kline(2:end).^-1).*EmeanVec(2:end))/trapz(kline(2:end),EmeanVec(2:end));
